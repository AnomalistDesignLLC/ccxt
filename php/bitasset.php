...
class bitasset extends Exchange {
    ...
    public function describe () {
        return array_replace_recursive (parent::describe (), array (
            ...
            'urls' => array (
                ...
                'fees' => array (
                    'https://bitasset.zendesk.com/hc/en-us/articles/115003684371-BITTREX-SERVICE-FEES-AND-WITHDRAWAL-LIMITATIONS',
            ...
            'options' => array (
                ...
                // With Bitasset some currencies imply the "base address . tag" logic.
    ...
    public function fetch_markets ($params = array ()) {
        ...
        for ($i = 0; $i < count ($markets); $i++) {
            ...
            // bitasset uses boolean values, bleutrade uses strings
    ...
    public function fetch_deposits ($code = null, $since = null, $limit = null, $params = array ()) {
        $this->load_markets();
        // https://support.bitasset.com/hc/en-us/articles/115003723911
        $request = array ();
        $currency = null;
        if ($code !== null) {
        ...
        //
        // we cannot filter by `$since` timestamp, as it isn't set by Bitasset
    ...
    public function parse_transaction ($transaction, $currency = null) {
        ...
        if ($feeCost === null) {
            if ($type === 'deposit') {
                // according to https://support.bitasset.com/hc/en-us/articles/115000199651-What-fees-does-Bitasset-charge-
